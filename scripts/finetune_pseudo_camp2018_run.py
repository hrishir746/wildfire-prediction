...
stacks = []
labels = []
print('Building pseudo-dataset (this may take a few minutes)...')
for i in range(n_samples):
    ...
    try:
        ...
        stack = build_real_input_stack(bbox[0], bbox[1], bbox[2], bbox[3], size, initial_fire=init, dem_source='3dep', fetch_wind_from_nws=False)
...
out_ckpt = ROOT / 'outputs' / 'checkpoints' / 'unet_finetune_camp2018_large.pt'
