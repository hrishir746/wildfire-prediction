#!/usr/bin/env python3
"""
Train U-Net on augmented FIRMS dataset (2400 samples).
Input: data/firms_progressions/firms_progressions_augmented.npz
Output: outputs/checkpoints/unet_firms_augmented.pt
"""
import sys
...
def main():
    print("=" * 80)
    print("TRAIN AUGMENTED FIRMS MODEL (8X MORE DATA)")
    print("=" * 80)
    ...
    if not DATASET_PATH.exists():
        ...
        print("Run: python scripts/augment_firms_data.py")
        sys.exit(1)
    ...
    # 8-channel input with stronger dropout for augmented data
    ...
    if best_val_iou > 0.0662:
        ...
        print(f"  ✗ Decrease: {(best_val_iou - 0.0662)*100:.2f}%")
