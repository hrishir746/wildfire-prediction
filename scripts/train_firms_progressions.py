#!/usr/bin/env python3
"""
Train U-Net on FIRMS day-to-day progression dataset.
Input: data/firms_progressions/firms_progressions_*.npz
Output: outputs/checkpoints/unet_firms_progressions.pt
"""
import sys
...
OUTPUT_MODEL = ROOT / "outputs" / "checkpoints" / "unet_firms_progressions.pt"
METRICS_FILE = ROOT / "outputs" / "firms_progressions_training_metrics.json"
...
def main():
    print("=" * 80)
    print("TRAIN FIRMS PROGRESSION MODEL")
    print("=" * 80)
