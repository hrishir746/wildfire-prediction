...
# -*- coding: utf-8 -*-
"""
TRAINING SCRIPT WITH LIVE DASHBOARD INTEGRATION
Train U-Net with real-time metrics logging for dashboard monitoring.
...
def main():
    parser = argparse.ArgumentParser(description="Train with live dashboard monitoring")
    ...
    print("=" * 80)
    print("WILDFIRE TRAINING WITH LIVE DASHBOARD")
    print("=" * 80)
    ...
    full_dataset = WildfireSyntheticDataset(
